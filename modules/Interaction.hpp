...
void shouldPrintDebugVariables(GLFWwindow* window, glm::vec3 Pos, float Yaw, CameraData cameraData, float tx, float tz, float SteeringAng, float wheelRoll, bool* debounce, int* curDebounce, std::function<void(const char*, glm::vec3)> printVec3){
